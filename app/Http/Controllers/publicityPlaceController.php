...
class publicityPlaceController extends Controller
{
    public function __construct() {
        ...
        $this->middleware('permission:Lista de administración de espacios publicitarios|Crear espacios publicitarios|Ver espacios publicitarios|Editar espacios publicitarios|Rentar espacios publicitarios|Eliminar espacios publicitarios', ['only' => ['index']]);
        $this->middleware('permission:Crear espacios publicitarios', ['only' => ['create','store']]);
        $this->middleware('permission:Ver espacios publicitarios', ['only' => ['show']]);
        $this->middleware('permission:Editar espacios publicitarios', ['only' => ['edit','update']]);
        $this->middleware('permission:Rentar espacios publicitarios', ['only' => ['add','save']]);
        $this->middleware('permission:Eliminar espacios publicitarios', ['only' => ['destroy']]);
    }
