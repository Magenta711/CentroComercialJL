...
class localsController extends Controller
{
    public function __construct() {
        ...
        $this->middleware('permission:Lista de administración de locales|Crear locales|Ver locales|Editar locales|Rentar locales|Eliminar locales', ['only' => ['index']]);
        $this->middleware('permission:Crear locales', ['only' => ['create','store']]);
        $this->middleware('permission:Ver locales', ['only' => ['show']]);
        $this->middleware('permission:Editar locales', ['only' => ['edit','update']]);
        $this->middleware('permission:Rentar locales', ['only' => ['add','save']]);
        $this->middleware('permission:Eliminar locales', ['only' => ['destroy']]);
    }
