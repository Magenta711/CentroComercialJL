...
<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="dimensions">Dimnesiones</label>
                    <p>{{$id->dimensions}}</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <p>$ {{isset($id->value) ? number_format($id->value, 2) : "0"}} COP</p>
                    {{-- <p>$ {{number_format($id->value, 2)}} COP</p> --}}
                    {{-- {{isset($minor_box_unapproved['caja']) ? '$'.number_format($minor_box_unapproved['caja'],2)  : "$0" }} --}}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
