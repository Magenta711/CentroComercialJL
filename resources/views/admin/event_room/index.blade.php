...
@section('css')
    <link href="{{asset('eliteadmin/assets/node_modules/calendar/dist/fullcalendar.css')}}" rel="stylesheet" />
@endsection
@section('js')
    <script src="{{asset('eliteadmin/assets/node_modules/calendar/jquery-ui.min.js')}}"></script>
    <script src="{{asset('eliteadmin/assets/node_modules/moment/moment.js')}}"></script>
    <script src='{{asset('eliteadmin/assets/node_modules/calendar/dist/fullcalendar.min.js')}}'></script>
    <script src="{{asset('eliteadmin/assets/node_modules/calendar/dist/cal-init.js')}}"></script>
@endsection